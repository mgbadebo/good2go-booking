    ...
    <div class="flex flex-col min-h-screen">
        ...
        <header class="border-b border-slate-200 bg-white/80 backdrop-blur sticky top-0 z-50">
            <nav class="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
                ...
                {{-- Mobile menu button --}}
                <button id="mobileMenuToggle" type="button" class="md:hidden p-2 rounded-md text-slate-600 hover:text-slate-900 hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500" aria-label="Toggle navigation">
                    <svg id="mobileMenuIconOpen" class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                    <svg id="mobileMenuIconClose" class="h-6 w-6 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div id="mobileMenu" class="md:hidden border-t border-slate-200 bg-white hidden">
